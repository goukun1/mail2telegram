...
export function GearIcon(props: IconProps) {
    return (
        <Svg {...props}>
            ...
            <path d="M12 2.8v2.4M12 18.8v2.4M4.5 7.2l2.1 1.2M17.4 15.6l2.1 1.2M4.5 16.8l2.1-1.2M17.4 8.4l2.1-1.2" />
        </Svg>
    );
}
...
export function GitHubIcon(props: IconProps) {
    return (
        <svg width={props.size ?? 24} height={props.size ?? 24} viewBox="0 0 16 16" fill="currentColor" aria-hidden {...props}>
